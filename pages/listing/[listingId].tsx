...
import { useContract, useNetwork, useNetworkMismatch, useMakeBid, useOffers, useMakeOffer, useBuyNow, MediaRenderer, useAddress, useListing, useAcceptDirectListingOffer } from '@thirdweb-dev/react'
...
const ListingId = (props: Props) => {
    ...
    const { contract: marketplaceContract } = useContract(process.env.NEXT_PUBLIC_MARKETPLACE_CONTRACT, 'marketplace')
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        {listing.sellerAddress === address && (
                                            ...
                                            }} className=' p-2 w-32 bg-red-500/50 rounded-lg font-bold text-xs cursor-pointer'>Accept Offer</button>
                                        )}
                                    </div>
                                </>
                            ))}
