        ...
        <div className=' max-w-6xl mx-auto p-2'>
            <nav className='flex justify-between'>
                <div className='flex items-center space-x-2 text-sm'>
                    ...
                    <p className='headerLink md:inline-flex'>Daily Deals</p>
                    <p className='headerLink md:inline-flex'>Help & Contact</p>
                </div>
                <div className='flex items-center space-x-4 text-sm'>
                    <p className='headerLink md:inline-flex'>Ship to</p>
                    <p className='headerLink md:inline-flex'>Sell</p>
                    <p className='headerLink md:inline-flex'>Watchlist</p>
                    <Link className=' flex items-center hover:link' href='/addItem'>Add to inventory <ChevronDownIcon className='h-4' /></Link>
            ...
            <section className=' flex items-center space-x-2 py-5'>
                <div className=' h-16 w-16 sm:w-28 md:w-44 cursor-pointer flex-shrink-0'>
                    <Link href='/'>
                        <Image className=' h-full w-full object-contain' alt='Thirdweb Logo' src='https://upload.wikimedia.org/wikipedia/commons/4/48/EBay_logo.png' width={100} height={100} />
                    </Link>
                </div>
            ...
            <hr />
            <section className=' flex items-center space-x-6 py-3 text-xs md:text-sm whitespace-nowrap justify-center px-6'>
                ...
                <p className='hover:link hidden xl:inline'>Other</p>
